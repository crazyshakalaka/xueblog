    ...
    <div id="main_1">
      <el-container>
        ...
        <el-main id="main">
          ...
          <mark-down @on-save="getContent" :interval="500" autoSave :initialValue="content"/>
          <el-button type="success" plain @click="createArticle">创建文章</el-button>
        </el-main>
      </el-container>
    </div>
  </div>
