  				...
  				<el-main id="main">
				    ...
				    <el-table-column
				      ...
				      <template slot-scope="scope">
				        <el-button @click="dlt(scope.row.id)" type="text" size="small">删除</el-button>
				      </template>
				    </el-table-column>
				  </el-table>
				  <div class="block">
...
import {commentlist,deletecomment} from "../../api/houtai";
...
export default {
  ...
  methods: {
      ...
      init(){
        commentlist({page:this.page,size:this.size}).then(res =>{
          if (res.code === 0){
            let data = res.data
